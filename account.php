        ...
        <div class="forma" style="border-radius:25px">
            <form method="post" id="registrationAccForm">
                ...
                <div class="form-check container">
                    <input class="form-check-input" type="radio" name="gender" value="M" id="radioM" <?php if ($user['gender'] == 'M') echo 'checked'; ?>>
                    <label class="form-check-label" for="radioM">
                        Male
                    </label>
                </div>
                <div class="form-check container">
                    <input class="form-check-input" type="radio" name="gender" value="F" id="radioF" <?php if ($user['gender'] == 'F') echo 'checked'; ?>>
